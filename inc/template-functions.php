...
function remotestore_get_featured_categories( $limit = 8 ) {
    ...
    // Get categories from the customizer settings
...
/**
 * Get products on sale for the homepage.
 *
 * @param int $limit Number of products to return.
 * @return WP_Query
 */
function remotestore_get_sale_products( $limit = 8 ) {
    ...
    // Get products from the customizer settings
    $selected_products = get_theme_mod( 'remotestore_deal_products', array() );

    // If no products are selected, get products on sale
...
/**
 * Get products from a specific category for the homepage.
 *
 * @param int $category_id Category ID.
 * @param int $limit Number of products to return.
 * @return WP_Query
 */
function remotestore_get_category_products( $category_id, $limit = 4 ) {
 ...
 * @return WP_Query
 */
function remotestore_get_latest_products( $limit = 8 ) {
    if ( ! class_exists( 'WooCommerce' ) ) {
        return null;
    }
...
/**
 * Get best selling products for the homepage.
 *
 * @param int $limit Number of products to return.
 * @return WP_Query
 */
